...
(function () {
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Comme le lagon est beau ce soir !', 'exclamative'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['La [[joie]] de Hinano fait plaisir à voir.', 'nom', 'Un nom peut aussi désigner une idée ou un sentiment : la joie, la peur…'],
      ...
      ['Wakana [[danse]] dans la cour.', 'verbe', 'On peut changer le temps : <i>Wakana dansait</i>. C’est un verbe.'],
      ...
      ['Kylian [[est]] très bavard.', 'verbe',
        '« est », c’est le verbe <b>être</b> : il ne dit pas une action, mais un état. Il se conjugue : <i>Kylian était bavard</i>.'],
      ...
      ['Teva a perdu [[son]] bonnet.', 'determinant', '« son » est placé devant le nom « bonnet » : c’est un déterminant.'],
  ...
  const SUJETS = [
    ...
    ['Maëva [[offre]] un livre à Noa.', 'Maëva', ['un livre', 'Noa'], 'C’est [[Maëva]] qui offre un livre.'],
    ['Le facteur [[apporte]] un colis à Inès.', 'le facteur', ['un colis', 'Inès'], 'C’est [[le facteur]] qui apporte un colis.'],
    ['Roxy [[cherche]] des mûres avec Sione.', 'Roxy', ['des mûres', 'Sione'], 'C’est [[Roxy]] qui cherche des mûres.',
      '« avec Sione » n’est pas le sujet : Sione accompagne Roxy. Si Sione était sujet lui aussi, on dirait « Roxy et Sione cherchent ».'],
    ...
    ['Les élèves de la classe de Mei [[préparent]] un spectacle pour Noël.', 'les élèves de la classe de Mei',
      ['un spectacle', 'Noël'], 'Ce sont [[les élèves de la classe de Mei]] qui préparent un spectacle.'],
    ...
    ['Wanir, après l’école, [[joue]] au football avec Sami.', 'Wanir', ['l’école', 'Sami'],
      'C’est [[Wanir]] qui joue au football.', 'Le sujet est séparé du verbe par « après l’école ».'],
    ...
    // Plusieurs sujets
    ['Cet été, Kalia et Teva [[partent]] à l’île des Pins.', 'Kalia et Teva', ['cet été', 'l’île des Pins'],
      'Ce sont [[Kalia et Teva]] qui partent à l’île des Pins.', 'Le sujet est formé de deux noms reliés par « et » : le verbe est au pluriel.'],
    ...
    ['Ilona, Zoé et Sione [[chantent]] dans la chorale de l’école.', 'Ilona, Zoé et Sione', ['la chorale', 'l’école'],
      'Ce sont [[Ilona, Zoé et Sione]] qui chantent.', 'Le sujet est formé de trois noms reliés par « et » : le verbe est au pluriel.'],
    // Un pronom sujet
    ...
    ['Demain, tu [[prêteras]] ton vélo à Minh.', 'tu', ['demain', 'ton vélo', 'Minh'],
      'C’est [[toi]] qui prêteras ton vélo à Minh.', 'Avec « c’est… qui », le pronom « tu » devient « toi ».'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Nous pique-niquons [[sur la plage]].', 'lieu', 'Où pique-niquons-nous ? <b>Sur la plage</b>.'],
      ...
      ['Ethan lit une bande dessinée [[à la bibliothèque]].', 'lieu', 'Où Ethan lit-il ? <b>À la bibliothèque</b>.'],
      ['Les tortues nagent [[dans le lagon]].', 'lieu', 'Où les tortues nagent-elles ? <b>Dans le lagon</b>.'],
      ...
      ['Il a plu [[pendant toute la nuit]].', 'temps', 'Pendant combien de temps a-t-il plu ? <b>Pendant toute la nuit</b>.'],
      ['[[Après l’école]], Anaïs fait ses devoirs.', 'temps',
        'Quand Anaïs fait-elle ses devoirs ? <b>Après l’école</b>. L’école est un lieu, mais « après l’école » dit <b>quand</b>.'],
      ...
      ['Teva apprend le piano [[depuis deux ans]].', 'temps', 'Depuis combien de temps Teva apprend-il le piano ? <b>Depuis deux ans</b>.'],
      ...
      ['Sélène colorie son dessin [[avec soin]].', 'maniere', 'Comment Sélène colorie-t-elle son dessin ? <b>Avec soin</b>.'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      devantNom('Noa grimpe dans [[l’]]arbre.', 'arbre'),
      ...
      devantNom('Le livre de Kylian ? Il est resté sur [[l’]]étagère.', 'étagère'),
      ...
      remplace('Hinano cherche son chat partout et [[le]] trouve enfin sous le lit.', 'son chat'),
      remplace('Sami ouvre la fenêtre et [[la]] referme aussitôt.', 'la fenêtre'),
      ['Sione écrit à ses cousins et [[leur]] envoie des photos.', 'pronom',
        'Ici, « leur » remplace « à ses cousins » (Sione envoie des photos <b>à ses cousins</b>).'],
      ...
      remplace('Le livre de Kylian ? Il [[l’]]a oublié à l’école.', 'le livre de Kylian'),
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Je vais au parc [[avec]] Kalia.', 'preposition'],
      ...
      ['Le livre [[de]] Mei est sur la table.', 'preposition', '« de » relie le nom « livre » à son complément « Mei ».'],
      ...
      ['Roxy marche [[entre]] Wakana et Teva.', 'preposition'],
      ...
      ['Maëva [[et]] Inès sont amies.', 'conjonction'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Wanir attend [[son frère]].', 'cod', 'Wanir attend <b>qui</b> ? → son frère.'],
      ...
      ['Enzo boit [[du jus d’orange]].', 'cod',
        'Enzo boit <b>quoi</b> ? → du jus d’orange. Ici, « du » est un déterminant (= un peu de), pas une préposition.'],
      ...
      ['Sélène danse : je [[la]] regarde.', 'cod',
        'Je regarde <b>qui</b> ? → la (= Sélène). On dit « regarder quelqu’un », sans préposition.'],
      ...
      ['Hinano téléphone [[à sa grand-mère]].', 'coi', 'Hinano téléphone <b>à qui</b> ? → à sa grand-mère.'],
      ['Sami ressemble [[à son père]].', 'coi', 'Sami ressemble <b>à qui</b> ? → à son père.'],
      ['Émeline s’occupe [[de son petit frère]].', 'coi', 'Émeline s’occupe <b>de qui</b> ? → de son petit frère.'],
      ...
      ['Minh est triste : Kalia [[lui]] parle doucement.', 'coi',
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Maëva deviendra [[une grande musicienne]].', 'attribut',
        'Remplace le verbe par « être » : <i>Maëva sera une grande musicienne.</i> ✔ C’est la même personne.'],
      ['Le hérisson est [[un animal nocturne]].', 'attribut', '« un animal nocturne » dit ce qu’est le hérisson.'],
      ['Teva deviendra [[un bon nageur]].', 'attribut',
        'Remplace le verbe par « être » : <i>Teva sera un bon nageur.</i> ✔ Teva et le nageur, c’est la même personne.'],
      ...
      ['Maëva écoute [[une grande musicienne]].', 'cod',
        'Ici, Maëva écoute quelqu’un d’autre : ce sont deux personnes différentes. « écouter » n’est pas un verbe d’état.'],
      ['Le hérisson cherche [[des escargots]].', 'cod',
        'Le hérisson cherche <b>quoi</b> ? → des escargots. « chercher » n’est pas un verbe d’état.'],
      ['Ilona prépare [[un gâteau au chocolat]].', 'cod',
        'Ilona prépare <b>quoi</b> ? → un gâteau au chocolat. « préparer » est un verbe d’action.'],
