...
(function () {
  ...
  ajouterHomophones({
    ...
    phrases: {
      ...
      quant: ['Mes amis sont partis ; ___ à moi, je reste.', 'Wakana aime le lagon ; ___ à Tom, il préfère la brousse.',
      ...
      'qu’en': ['Je me demande ce ___ pense Roxy.', 'Il ne sort ___ cas de besoin.',
        ...
        'Elle ne parle ___ anglais.', 'On ne trouve le cagou ___ Nouvelle-Calédonie.'],
    },
