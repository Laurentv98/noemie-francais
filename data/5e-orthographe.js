...
(function () {
  ...
  ajouterHomophones({
    ...
    phrases: {
      ce: [['J’adore ___ livre.', 'nom'], ['Regarde ___ nuage !', 'nom'], ['Tu connais ___ garçon ?', 'nom'],
        ...
        ['Pendant ___ temps, Tom attendait.', 'nom'], ['À ___ moment-là, le téléphone sonna.', 'nom'],
  ...
  ajouterHomophones({
    ...
    phrases: {
      ...
      's’est': ['Roxy ___ cachée derrière l’arbre.', 'Le chat ___ endormi sur le canapé.', 'Il ___ levé très tôt.',
        'Elle ___ promenée dans la forêt.', 'Tom ___ fait mal au genou.', 'La porte ___ ouverte toute seule.',
        'Le renard ___ approché doucement.', 'Ma sœur ___ trompée de chemin.', 'Il ___ souvenu de ton prénom.',
        'Le soleil ___ couché derrière la colline.', 'Léa ___ bien amusée à la fête.', 'Le bébé ___ mis à pleurer.'],
    },
  ...
  ajouterHomophones({
    ...
    phrases: {
      ...
      leurs: [['Les enfants rangent ___ jouets.', 'nom'], ['Les oiseaux nourrissent ___ petits.', 'nom'],
  ...
  ajouterHomophones({
    ...
    phrases: {
      ...
      là: ['Pose ton sac ___.', 'Je suis ___ !', 'Viens par ___ !', 'Ce jour-___, il neigeait.', 'Qui est ___ ?',
