...
(function () {
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Kylian dort comme un loir.', 'comparaison', 'Kylian est rapproché d’un loir grâce à l’outil « <b>comme</b> ».'],
      ...
      ['Ilona attend son bus depuis des siècles.', 'hyperbole', 'Des siècles ? Elle attend depuis longtemps, mais c’est <b>exagéré</b> !'],
  ...
  const MOTS_RARES = [
    ...
    ['éloquent', 'qui sait convaincre en parlant', ['qui parle d’une voix aiguë', 'qui bégaie souvent', 'qui parle sans arrêt'],
      'Grâce à un discours éloquent, Sélène a été élue déléguée.'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['[[Évidemment]], Hinano a gagné la course.', 'certitude'],
      ...
      ['Maëva viendra [[peut-être]] ce soir.', 'doute'],
      ...
      ['[[Apparemment]], Noa a perdu sa casquette.', 'doute',
  ...
  const LOCUTIONS = [
    ...
    ['in extremis', 'au tout dernier moment', ['à égalité', 'pour toujours', 'de ses propres yeux'],
      'Teva a attrapé son bus ___, juste avant la fermeture des portes.', ['ex aequo', 'de visu', 'vice versa'],
    ...
    ['ex aequo', 'à égalité', ['en gros, à peu près', 'au tout dernier moment', 'pour toujours'],
      'Wakana et Inès ont fini la course ___ : elles partagent la première place.', ['vice versa', 'de visu', 'ad vitam aeternam'],
    ...
    ['alter ego', 'un autre soi-même', ['un ennemi juré', 'un parfait inconnu', 'un chef sévère'],
      'Léa ne fait rien sans Mei : Mei est son ___, son double.', ['mea culpa', 'statu quo', 'post-scriptum'],
    ...
    ['a fortiori', 'à plus forte raison', ['au dernier moment', 'par erreur', 'de force'],
      'Si Sione n’arrive pas à soulever ce sac, ___ son petit frère n’y arrivera pas.', ['vice versa', 'ex aequo', 'illico'],
    ...
    ['idem', 'la même chose', ['le contraire', 'rien du tout', 'et le reste'],
      'Hinano a choisi une glace à la mangue, et Tom ___ : il adore la mangue, lui aussi.', ['ex aequo', 'de visu', 'manu militari'],
