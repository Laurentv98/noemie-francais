...
(function () {
  ...
  const EXPANSIONS = [
    ...
    ['Tom a enfilé ses bottes [[jaunes]].', 'epithete', 'bottes'],
    ...
    ['Hugo a adopté un chaton [[noir]].', 'epithete', 'chaton'],
    ...
    ['Zoé a perdu la clé [[du garage]].', 'complement', 'clé'],
    ...
    ['Léa, [[la meilleure amie de Zoé]], arrive demain.', 'apposition', 'Léa'],
    ['[[Excellente nageuse]], Inès a gagné la course.', 'apposition', 'Inès'],
    ['Voici Médor, [[le chien de nos voisins]].', 'apposition', 'Médor'],
    ['Le chêne, [[roi de la forêt]], domine la clairière.', 'apposition', 'le chêne'],
    ['Tom, [[le capitaine de l’équipe]], encourage ses amis.', 'apposition', 'Tom'],
  ...
  const RELATIFS = [
    ...
    ['Le chien ___ Zoé a peur aboie très fort.', 'dont', 'Zoé a peur <b>de ce chien</b>'],
    ...
    ['C’était l’année ___ Léa est entrée au collège.', 'où', 'Léa est entrée au collège <b>cette année-là</b>', 'temps'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Je crois [[qu’il va neiger]].', 'completive',
        '« qu’ » n’a pas d’antécédent : c’est une conjonction. La subordonnée est COD du verbe « crois » (je crois quoi ?).'],
      ['Léa espère [[que ses amis viendront]].', 'completive',
        '« que » n’a pas d’antécédent : c’est une conjonction. La subordonnée est COD du verbe « espère » (Léa espère quoi ?).'],
      ...
      ['[[Bien qu’il soit fatigué]], Hugo termine ses devoirs.', 'circonstancielle',
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['[[Comme Zoé était malade]], elle n’est pas venue.', 'cause',
        'En tête de phrase, « comme » veut dire ici « parce que ».'],
      ['Nous prenons nos parapluies [[puisque le ciel est gris]].', 'cause',
        '« puisque » donne la raison : le ciel gris explique les parapluies.'],
      ['Hugo a très faim [[parce qu’il a beaucoup couru]].', 'cause',
        'Pourquoi Hugo a-t-il faim ? Parce qu’il a beaucoup couru : c’est la cause.'],
      ['Il a beaucoup neigé, [[si bien que l’école est fermée]].', 'consequence',
        '« si bien que » : l’école fermée est le résultat de la neige.'],
      ['Il faisait si froid [[que le lac a gelé]].', 'consequence',
        '« si… que » : le lac gelé est le résultat du grand froid.'],
      ...
      ['Léa s’est entraînée tous les jours, [[si bien qu’elle a gagné la course]].', 'consequence',
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Léa n’aime plus les épinards.', 'negative', 'La négation : « ne… plus ».'],
      ...
      ['Il n’a jamais vu la mer.', 'negative',
        'La négation : « ne… jamais ». Ici, « il » désigne quelqu’un (Papi n’a jamais vu la mer) : '
          + 'la phrase n’est pas impersonnelle.'],
      ['Zoé n’est pas encore rentrée.', 'negative',
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Demain, Léa [[prendra]] le train.', 'indicatif',
        'Le verbe a un sujet, « Léa », et annonce un fait : futur de l’indicatif.'],
      ...
      ['Avant de [[dormir]], Léa lit une histoire.', 'infinitif', 'Après la préposition « de », le verbe est à l’infinitif.'],
      ['Nous allons [[visiter]] le château.', 'infinitif',
        'C’est « allons » qui est conjugué : le verbe souligné reste à l’infinitif.'],
      ['Tom apprend à [[nager]].', 'infinitif', 'Après la préposition « à », le verbe est à l’infinitif.'],
