...
(function () {
  ...
  const PRONOMINAUX = [
    ...
    ['Hinano s’est ___ les cheveux.', 'brossé', 'codApres', ['les cheveux', 'à elle-même']],
  ...
  const NOMBRES = [
    ...
    ['Ce bougna coûte ___ francs.', '1000', 'mille', ['milles'], 'mille'],
    ...
    ['Ce bonbon coûte ___ francs.', '20', 'vingt', ['vingts'], 'vingtSeul'],
  ...
  const HOMOPHONES = [
    ...
    ['Wanir a fêté ___ douze ans.', 'ses', 'ces'], ['Je crois que ___ l’heure.', 'c’est', 'ces'],
