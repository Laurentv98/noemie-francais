...
(function () {
  ...
  const IMPARFAIT_OU_PASSE_SIMPLE = [
    ...
    ['Quand j’étais petite, je ___ souvent au parc.', 'jouer', 0, 'imparfait', 'souvent'],
  ...
  const FUTUR_OU_CONDITIONNEL = [
    ...
    ['Samedi, j’___ à la piscine avec Léa.', 'aller', 0, 'futur', 'samedi'],
    ...
    ['J’___ tellement voir la mer !', 'aimer', 0, 'conditionnel', 'un souhait'],
