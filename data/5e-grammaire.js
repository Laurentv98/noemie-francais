...
(function () {
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Le [[rire]] de Hinano est contagieux.', 'nom',
      ...
      ['Teva mange [[du]] pain au petit déjeuner.', 'determinant',
      ...
      ['Ce stylo est à Mei ; [[celui-ci]] est à moi.', 'pronom'],
      ...
      ['[[Hier]], Wanir a perdu une dent.', 'adverbe'],
      ...
      ['Kalia va à l’école [[avec]] son frère.', 'preposition'],
  ...
  ajouterClassement({
    ...
    banque: [
      ['Maëva est au jardin : [[elle]] cueille des mûres.', 'personnel'],
      ...
      ['Kylian a perdu sa casquette, alors Sélène lui prête [[la sienne]].', 'possessif'],
      ...
      ['[[Celle]] qui a gagné la course s’appelle Anaïs.', 'demonstratif',
      ...
      ['Ces livres-ci sont à moi, [[ceux-là]] sont à Noa.', 'demonstratif'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['[[Courir]] est le sport préféré de Sione.', 'sujet',
        'Un verbe à l’infinitif peut être sujet. Qu’est-ce qui est le sport préféré de Sione ? → courir.'],
      ...
      ['Wakana cueille [[des mûres]].', 'cod',
        'Ici, « des » est un déterminant (une mûre, des mûres), pas une préposition. Wakana cueille quoi ? → des mûres.'],
      ...
      ['Minh pense souvent [[à ses vacances]].', 'coi'],
      ...
      ['Teva deviendra [[un grand pianiste]].', 'attribut',
        'Après le verbe d’état « devenir », le groupe nominal « un grand pianiste » dit ce que sera Teva : c’est un attribut du sujet.'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Mamie a planté des hibiscus [[devant la maison]].', 'lieu'],
      ...
      ['[[Pendant les vacances]], Kalia a appris à nager.', 'temps'],
      ...
      ['Noa lit une histoire [[avant de dormir]].', 'temps',
        'Quand Noa lit-il une histoire ? → avant de dormir. « Avant de » indique le temps.'],
      ...
      ['Wanir a ouvert son cadeau [[avec impatience]].', 'maniere'],
      ['Ilona chante [[à voix basse]].', 'maniere'],
      ['Le match est annulé [[à cause du cyclone]].', 'cause'],
      ...
      ['Émeline n’a rien dit [[par timidité]].', 'cause',
        'Pour quelle raison Émeline n’a-t-elle rien dit ? → parce qu’elle est timide.'],
      ...
      ['Sione s’entraîne [[afin de gagner la course]].', 'but'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['En sortant de l’école, Teva a rencontré son cousin.', 'simple',
      ...
      ['Les élèves de la classe de Mei ont préparé un spectacle pour la fête de l’école.', 'simple',
      ...
      ['Minh mange une pomme, Hinano boit un jus d’orange.', 'complexe',
      ...
      ['Kylian voulait venir, mais il était malade.', 'complexe',
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Wakana lit, Sione dessine.', 'juxtaposition',
        'Le signe qui relie : une <b>virgule</b>, sans mot de liaison.'],
      ...
      ['Noa a couru très vite, mais il a perdu la course.', 'coordination',
        'Le mot qui relie : <b>mais</b>, une conjonction de coordination. La virgule ne change rien.'],
      ...
      ['Sélène sourit quand elle voit son chat.', 'subordination',
        'Le mot qui relie : <b>quand</b>, une conjonction de subordination.'],
