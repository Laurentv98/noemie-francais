...
(function () {
  ...
  const PARONYMES = [
    ...
    ['Tom était ___ par la défaite de son équipe préférée.', 'affligé', 'infligé', 'infliger'],
    ...
    ['Depuis toute petite, Inès a une ___ pour la musique.', 'inclination', 'inclinaison', 'inclinaison'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Les cheveux de Léa sont doux comme de la soie.', 'comparaison',
      ...
      ['Quand Zoé rit, on l’entend jusqu’à l’autre bout de la Terre.', 'hyperbole',
        'C’est impossible : on <b>exagère</b> pour dire que Zoé rit très fort.'],
  ...
  const CONNECTEURS = [
    // La cause
    ['Léa met son bonnet, ___ il neige dehors.', 'car', ['c’est pourquoi', 'pourtant'], 'cause',
      'Pourquoi Léa met-elle son bonnet ? Parce qu’il neige.'],
    ...
    ['Zoé n’a pas pris son parapluie. ___, il faisait grand soleil ce matin.', 'En effet', ['Pourtant', 'Par conséquent'], 'cause',
      'Pourquoi Zoé n’a-t-elle pas pris son parapluie ? Parce qu’il faisait beau.'],
    ...
    ['Tom a révisé toute la soirée, ___ le lendemain, il avait tout oublié.', 'pourtant', ['car', 'donc'], 'opposition',
    ...
    ['Les fraises sont délicieuses. ___, elles sont pleines de vitamines.', 'De plus', ['Par conséquent', 'Par exemple'], 'addition',
      'On ajoute une deuxième qualité à la première.'],
    // L’exemple
    ...
    ['D’abord, Tom lave les légumes. Puis il les épluche. ___, il les fait cuire.', 'Enfin', ['Pourtant', 'Par exemple', 'En effet'], 'temps',
  ...
  ajouterClassement({
    ...
    banque: [
      ['Mes grands-parents vivent dans une [[demeure]] au bord du lac.', 'melioratif',
      ...
      ['Ce matin, Léa a réussi une [[prouesse]] au trampoline.', 'melioratif',
      ...
      ['Au lieu de travailler, Hugo [[rêvasse]] en regardant par la fenêtre.', 'pejoratif',
