...
(function () {
  ...
  const HOMONYMES = [
    ...
    [['mer', 'mère', 'maire'], [
      ...
      ['Le soir, la ___ de Léa lui fait un câlin et lui lit une histoire.', 'mère'],
    ...
    [['cou', 'coup', 'coût'], [
      ...
      ['Tom a marqué le but d’un ___ de tête.', 'coup'],
    ...
    [['conte', 'compte', 'comte'], [
      ...
      ['À la fin de la partie, Hugo ___ ses points.', 'compte', 'le verbe compter (il compte)'],
    ...
    [['poids', 'pois', 'poix'], [
      ...
      ['Zoé porte une robe à ___.', 'pois', 'des petits ronds (une robe à pois)'],
    ]],
    [['vin', 'vingt', 'vain'], [
  ...
  const POLYSEMIE = [
    ...
    ['Papi m’a donné une [[pièce]] de deux euros.', 'pièce', 'monnaie', 'elle vaut « deux euros »'],
    ...
    ['Au restaurant, Zoé choisit son dessert sur la [[carte]].', 'carte', 'menu', 'Zoé y « choisit son dessert »'],
    ...
    ['Au dessert, Léa a pris une [[glace]] à la fraise.', 'glace', 'dessert', 'elle est « à la fraise », pour le dessert'],
    ...
    ['Pendant la visite, Sami prend des [[notes]] dans son carnet.', 'note', 'ecrit', 'Sami les écrit « dans son carnet »'],
    ...
    ['Zoé trempe ses [[pieds]] dans la rivière.', 'pied', 'corps', 'Zoé les « trempe » « dans la rivière »'],
  ...
  ajouterClassement({
    ...
    banque: [
      ['Léa saute partout en riant et serre tous ses amis dans ses bras.', 'joie',
      ...
      ['Inès court montrer son bulletin à ses parents en sautillant et en riant.', 'joie',
      ...
      ['Zoé sifflote en arrosant les fleurs, le sourire aux lèvres.', 'joie',
      ...
      ['Pendant l’orage, Tom se cache sous sa couette, les jambes en coton.', 'peur',
        'Les indices : il « se cache » pendant l’orage et a « les jambes en coton ».'],
      ['Devant la porte de la cave, Hugo a des sueurs froides et claque des dents.', 'peur',
      ...
      ['Tom serre les poings, devient tout rouge et claque la porte de sa chambre.', 'colere',
      ...
      ['Hugo grogne, serre les dents et froisse son brouillon en boule.', 'colere',
      ...
      ['Zoé croise les bras, fusille son frère du regard et refuse de lui parler.', 'colere',
      ...
      ['Après le match perdu, Sami rentre tête basse, les épaules tombantes, sans un mot.', 'tristesse',
        'Les indices : « tête basse », « les épaules tombantes », « sans un mot ».'],
      ['Zoé soupire, le regard perdu, et laisse son goûter sans y toucher.', 'tristesse',
        'Les indices : elle « soupire », « le regard perdu », et laisse son goûter « sans y toucher ».'],
      ['Tom regarde son cerf-volant déchiré ; une grosse larme roule sur sa joue.', 'tristesse',
        'Les indices : son cerf-volant est « déchiré » et « une grosse larme roule sur sa joue ».'],
      ['C’est la fin des vacances : Inès fait sa valise en soupirant, le cœur gros.', 'tristesse',
      ...
      ['Un pigeon entre dans la classe par la fenêtre : Léa en reste bouche bée, les sourcils levés.', 'surprise',
      ...
      ['Les sourcils levés, Inès regarde l’horloge : déjà midi ? Elle n’a pas vu le temps passer !', 'surprise',
      ...
      ['Hugo se frotte les yeux et n’en revient pas : un paon se promène dans la cour de l’école !', 'surprise',
