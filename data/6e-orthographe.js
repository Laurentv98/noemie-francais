...
(function () {
  ...
  ajouterHomophones({
    ...
    phrases: {
      a: ['Roxy ___ un joli foulard rouge.', 'Mon frère ___ peur du noir.', 'Le renard ___ une longue queue touffue.',
        'Hinano ___ mangé toute la tarte.', 'Mon chat ___ faim le matin.', 'Papa ___ oublié ses clés.',
      ...
      à: ['Je vais ___ l’école en bus.', 'Nous jouons ___ cache-cache.', 'Roxy habite ___ côté de la rivière.',
        ...
        'Ma grand-mère habite ___ Lifou.', 'Nous partons ___ la mer demain.', 'Elle parle ___ son amie.',
  ...
  ajouterHomophones({
    ...
    phrases: {
      est: ['Le ciel ___ tout bleu aujourd’hui.', 'Roxy ___ une renarde très curieuse.', 'Mon cartable ___ trop lourd.',
        ...
        'L’eau du lagon ___ turquoise.', 'Ce vélo ___ tout neuf.'],
      et: ['J’ai un chat ___ un chien.', 'Kalia ___ Wanir jouent ensemble.', 'Roxy saute ___ danse de joie.',
        ...
        'Elle ouvre la porte ___ elle sort.', 'J’aime les letchis ___ les mangues.', 'Papa ___ maman arrivent ce soir.',
  ...
  ajouterHomophones({
    ...
    phrases: {
      ...
      son: ['Léo range ___ cartable.', 'Roxy cherche ___ foulard.', 'Elle a perdu ___ crayon.',
        'Mon chat aime ___ panier.', 'Sione promène ___ chien.', 'Léa fête ___ anniversaire.',
        'Le bébé boit ___ biberon.', 'Il prend ___ vélo pour aller à l’école.', 'Papa met ___ pull.',
        'La maîtresse ouvre ___ livre.', 'Le renard retourne dans ___ terrier.', 'Mei téléphone à ___ oncle.',
  ...
  ajouterHomophones({
    ...
    phrases: {
      ...
      on: ['Demain, ___ ira à la piscine.', 'Le soir, ___ regarde les étoiles.', 'À la récré, ___ joue au loup.',
        ...
        'À la plage, ___ met un chapeau.', 'Dans la forêt, ___ entend les oiseaux.', 'Le dimanche, ___ fait des crêpes.',
  ...
  ajouterHomophones({
    ...
    phrases: {
      ses: [['Roxy lave ___ pattes.', 'sa patte'], ['Teva brosse ___ dents.', 'sa dent'],
        ...
        ['Wakana invite ___ amies à son anniversaire.', 'son amie'], ['Papa cherche ___ clés partout.', 'sa clé'],
        ['Le chien enterre ___ os dans le jardin.', 'son os'], ['Grand-père arrose ___ tomates.', 'sa tomate'],
        ['Mon frère met ___ chaussettes.', 'sa chaussette'], ['Chaque matin, Maëva coiffe ___ cheveux.', 'son cheveu'],
  ...
  const SUJET_VERBE = [
    ...
    ['Les letchis ___ au soleil.', 'rougir', 'ils', 'les letchis'],
    ...
    ['Sélène et moi ___ un gâteau.', 'faire', 'nous', 'Sélène et moi', '« Sélène et moi », c’est « nous » !'],
  ];
