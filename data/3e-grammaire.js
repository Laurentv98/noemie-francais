...
(function () {
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Hugo a lu un roman [[passionnant]].', 'adjectif', 'Il s’accorde (une histoire passionnante) : c’est un adjectif, pas un verbe.'],
      ...
      ['Inès est partie [[sans]] son parapluie.', 'preposition'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Hugo ressemble beaucoup [[à son grand frère]].', 'coi', 'On ressemble <b>à</b> quelqu’un : le groupe est construit avec une préposition, c’est le COI.'],
      ...
      ['Plus tard, Léa deviendra [[vétérinaire]].', 'attribut', 'Un nom peut aussi être attribut : « devenir » est un verbe d’état.'],
      ...
      ['Nous avons rencontré Sami, [[le nouveau voisin]].', 'apposition', 'Sami et « le nouveau voisin » désignent la même personne : c’est une apposition.'],
    ],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Le jour [[où nous sommes partis]], il neigeait.', 'relative', '« où » reprend le nom « jour » (son antécédent) : c’est une relative, même si elle parle de temps.'],
      ...
      ['Je me demande [[si Hugo viendra]].', 'interrogative', 'Ici, « si » ne pose pas de condition : il rapporte une question (Hugo viendra-t-il ?).'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Tom s’est entraîné tous les jours ; [[il a donc gagné la course]].', 'consequence'],
      ['La neige bloquait la route ; [[par conséquent, le car n’est pas venu]].', 'consequence'],
      ...
      ['Léa révise chaque soir [[pour réussir son brevet]].', 'but', 'Réussir le brevet est l’<b>objectif</b> de Léa, pas encore atteint : c’est un but.'],
      ...
      ['Mets ton bonnet [[pour ne pas avoir froid]].', 'but'],
      ...
      ['[[Contrairement à sa sœur]], Tom se lève tôt.', 'opposition'],
      ['Hugo adore la ville ; [[Inès, au contraire, préfère la campagne]].', 'opposition'],
      ...
      ['Il faisait très froid ; [[pourtant, Zoé est sortie sans manteau]].', 'concession'],
      ...
      ['[[Quoiqu’elle soit timide]], Inès a chanté devant toute l’école.', 'concession'],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Regarde par la fenêtre : il [[neige]] !', 'enonciation', 'Il neige maintenant, au moment où l’on parle : c’est un présent d’énonciation.'],
      ...
      ['Tous les matins, Léa [[prend]] le bus de 7 h 30.', 'habitude', '« Tous les matins » montre une action qui se répète : c’est une habitude de Léa.'],
      ['Chaque été, nous [[allons]] chez Mamie en Bretagne.', 'habitude'],
      ...
      ['Je [[pars]] demain en classe de neige.', 'futur', '« demain » montre que l’action n’a pas encore eu lieu : le présent a ici une valeur de futur.'],
      ...
      ['Inès [[arrive]] à peine de Lyon : laisse-la se reposer un peu.', 'passe'],
    ],
  ...
  const PHRASES_VOIX = [
    ...
    ['Tom [[a été invité]] à l’anniversaire de Zoé.', 'passive', '« a été invité » = être au passé composé + participe passé : Tom subit l’action (quelqu’un l’a invité).'],
