...
(function () {
  ...
  const SYNONYMES = [
    ...
    ['Teva a [[terminé]] ses devoirs.', 'fini', ['commencé', 'oublié', 'perdu']],
    ['Cette soupe est [[délicieuse]].', 'excellente', ['fade', 'froide', 'salée']],
    ['Mamie nous a [[donné]] un cadeau.', 'offert', ['pris', 'volé', 'caché']],
    ['Kalia a [[bâti]] une cabane.', 'construit', ['détruit', 'dessiné', 'cherché']],
  ...
  const CONTRAIRES = [
    ...
    ['Hinano [[monte]] l’escalier.', 'descend', 'grimpe', ['balaie', 'regarde']],
    ['Le chat [[entre]] par la fenêtre.', 'sort', 'pénètre', ['saute', 'regarde']],
    ['Tom a [[gagné]] la course.', 'perdu', 'remporté', ['couru', 'regardé']],
    ['Nous [[achetons]] des letchis au marché.', 'vendons', null, ['mangeons', 'coupons', 'cherchons']],
    ['Le train [[arrive]] en retard.', 'part', null, ['roule', 'siffle', 'freine']],
    ['Anaïs [[aime]] les épinards.', 'déteste', 'adore', ['cuisine', 'achète']],
    ...
    ['Mei dessine [[bien]].', 'mal', 'correctement', ['vite', 'souvent']],
    ...
    ['Tom et Sione sont des [[amis]].', 'ennemis', 'copains', ['voisins', 'cousins']],
  ];
  ...
  const SENS_PREFIXES = [
    ['Noa doit [[re]]faire son dessin.', 're', 'à nouveau', ['le contraire', 'avant', 'trop'],
    ...
    ['Minh [[dé]]boutonne sa veste.', 'dé', 'le contraire', ['à nouveau', 'avec', 'au-dessus'],
  ...
  const SENS_SUFFIXES = [
    ...
    ['Kylian est un bon jou[[eur]] de tennis.', 'eur', 'la personne qui fait', 'Un joueur, c’est <b>la personne qui</b> joue.'],
  ];
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Après la course, Teva sent son [[cœur]] battre fort.', 'propre', 'C’est le vrai cœur, qui bat dans la poitrine.'],
      ...
      ['Ilona [[brille]] en mathématiques.', 'figure', 'Ilona ne donne pas de lumière : elle est très forte en mathématiques.'],
      ...
      ['Maëva [[fond]] de tendresse devant le chaton.', 'figure', 'Maëva ne devient pas liquide : elle est très attendrie.'],
      ...
      ['Sélène [[caresse]] son chat.', 'propre', 'Sélène passe vraiment la main sur son chat.'],
      ...
      ['Wanir a toujours la tête dans les [[nuages]].', 'figure', 'Wanir n’est pas dans le ciel : il est distrait, il rêve.'],
    ],
  ...
  ajouterClassement({
    ...
    banque: [
      ...
      ['Enzo a oublié son [[livre]] à l’école.', 'courant', LIVRE],
      ...
      ['Émeline joue avec son [[ami]] Teva.', 'courant', AMI],
